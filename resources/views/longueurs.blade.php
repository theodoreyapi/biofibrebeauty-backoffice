...
@section('content')
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="title-main mb-0 h3">Gestion des longueurs</h2>
                </div>
            ...
            <div class="row g-4">
                @foreach ($longueurs as $item)
                    <div class="col-lg-4 col-md-6">
                        <div class="admin-product-card">
                            <div class="p-3">
                                <h5 class="fw-bold mb-1">{{ $item->valeur_longueur }}</h5>
                                <br>
                                <div class="d-flex gap-2">
                                    <button class="btn btn-outline-secondary w-100 btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#editProductModal{{ $item->id_longueur }}">
                                        <i class="bi bi-pencil-square me-2"></i>Modifier
                                    </button>

                                    <button class="btn btn-danger-soft btn-sm px-3" data-bs-toggle="modal"
                                        data-bs-target="#deleteProductModal{{ $item->id_longueur }}">
                    ...
                    <div class="modal fade" id="editProductModal{{ $item->id_longueur }}" tabindex="-1"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                                ...
                                <div class="modal-body p-4">
                                    <form action="{{ route('longueurs.update', $item->id_longueur) }}" method="POST"
                                        role="form">
                                        @csrf
                                        @method('PATCH')
                                        <div class="mb-3">
                                            ...
                                            <input name="categorie" required type="text"
                                                class="input-checkout border-gold-focus" value="{{ $item->valeur_longueur }}"
                    ...
                    <div class="modal fade" id="deleteProductModal{{ $item->id_longueur }}" tabindex="-1"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                                <div class="modal-header border-0 pb-0">
                                ...
                                <div class="modal-body p-4">
                                    <form action="{{ route('longueurs.destroy', $item->id_longueur) }}" method="POST"
                                        role="form">
                                        @csrf
                                        @method('DELETE')
                                        <div class="mb-3">
                                            <span>
                                                Êtes-vous sûr de vouloir supprimer cette longueur ?
                                            </span>
                                        </div>
    ...
    <div class="modal fade" id="addProductModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title fw-bold">Ajouter une longueur</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4">
                    <form action="{{ route('longueurs.store') }}" method="POST" role="form">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label-sm">Libelle</label>
